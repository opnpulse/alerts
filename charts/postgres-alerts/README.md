...
$ helm repo update
$ helm search repo appscode/postgres-alerts --version=v2026.2.24
$ helm upgrade -i postgres appscode/postgres-alerts -n demo --create-namespace --version=v2026.2.24
```
...
```bash
$ helm upgrade -i postgres appscode/postgres-alerts -n demo --create-namespace --version=v2026.2.24 --set metadata.resource.group=kubedb.com
```
...
```bash
$ helm upgrade -i postgres appscode/postgres-alerts -n demo --create-namespace --version=v2026.2.24 --values values.yaml
```
