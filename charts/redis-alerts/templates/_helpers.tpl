...
Common labels
*/}}
{{- define "redis-alerts.labels" -}}
helm.sh/chart: {{ include "redis-alerts.chart" . }}
{{ include "redis-alerts.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "redis-alerts.selectorLabels" -}}
app.kubernetes.io/name: {{ include "redis-alerts.name" . }}
...
Alert labels
*/}}
{{- define "redis-alerts.alertLabels" -}}
...
Alerts Enabled
*/}}
{{- define "redis-alerts.alertsEnabled" -}}
...
Alert Group Enabled
*/}}
{{- define "redis-alerts.alertGroupEnabled" -}}
{{- $ranks := dict "critical" 1 "warning" 2 "info" 3 -}}
{{- $flags := (mustLast .) -}}
...
Alert Enabled
*/}}
{{- define "redis-alerts.alertEnabled" -}}
{{- $ranks := dict "critical" 1 "warning" 2 "info" 3 -}}
