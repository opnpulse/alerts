...
$ helm repo update
$ helm search repo appscode/perconaxtradb-alerts --version=v2026.7.14
$ helm upgrade -i perconaxtradb appscode/perconaxtradb-alerts -n demo --create-namespace --version=v2026.7.14
```
...
The following table lists the configurable parameters of the `perconaxtradb-alerts` chart and their default values.
...
```bash
$ helm upgrade -i perconaxtradb appscode/perconaxtradb-alerts -n demo --create-namespace --version=v2026.7.14 --set metadata.resource.group=kubedb.com
```
...
```bash
$ helm upgrade -i perconaxtradb appscode/perconaxtradb-alerts -n demo --create-namespace --version=v2026.7.14 --values values.yaml
```
