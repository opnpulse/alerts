...
$ helm repo update
$ helm search repo appscode/openfga-alerts --version=v2026.7.14
$ helm upgrade -i openfga appscode/openfga-alerts -n demo --create-namespace --version=v2026.7.14
```
...
```bash
$ helm upgrade -i openfga appscode/openfga-alerts -n demo --create-namespace --version=v2026.7.14 --set metadata.resource.group=apps
```
...
```bash
$ helm upgrade -i openfga appscode/openfga-alerts -n demo --create-namespace --version=v2026.7.14 --values values.yaml
```
