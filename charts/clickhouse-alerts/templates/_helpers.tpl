...
*/}}
{{- define "clickhouse-alerts.fullname" -}}
{{- printf "%s%s" .Release.Name (.Values.form.alert.appSuffix | default "") | trunc 63 | trimSuffix "-" }}
{{- end }}

{{/*
Create chart name and version as used by the chart label.
*/}}
{{- define "clickhouse-alerts.chart" -}}
...
Common labels
*/}}
{{- define "clickhouse-alerts.labels" -}}
helm.sh/chart: {{ include "clickhouse-alerts.chart" . }}
{{ include "clickhouse-alerts.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "clickhouse-alerts.selectorLabels" -}}
app.kubernetes.io/name: {{ include "clickhouse-alerts.name" . }}
...
Alerts Enabled
*/}}
{{- define "clickhouse-alerts.alertsEnabled" -}}
...
Alert Group Enabled
*/}}
{{- define "clickhouse-alerts.alertGroupEnabled" -}}
{{- $ranks := dict "critical" 1 "warning" 2 "info" 3 -}}
{{- $flags := (mustLast .) -}}
...
Alert Enabled
*/}}
{{- define "clickhouse-alerts.alertEnabled" -}}
{{- $ranks := dict "critical" 1 "warning" 2 "info" 3 -}}
