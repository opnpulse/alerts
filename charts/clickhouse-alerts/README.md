...
| form.alert.appSuffix | Suffix appended to .Release.Name to form the application name ($app). Leave empty for standalone deployments. Set when deployed as a subchart to match the KubeDB resource suffix. | <code>""</code> |
