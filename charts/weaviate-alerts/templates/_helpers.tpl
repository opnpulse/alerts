...
*/}}
{{- define "weaviate-alerts.fullname" -}}
...
Common labels
*/}}
{{- define "weaviate-alerts.labels" -}}
helm.sh/chart: {{ include "weaviate-alerts.chart" . }}
{{ include "weaviate-alerts.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "weaviate-alerts.selectorLabels" -}}
app.kubernetes.io/name: {{ include "weaviate-alerts.name" . }}
...
Alerts Enabled
*/}}
{{- define "weaviate-alerts.alertsEnabled" -}}
...
Alert Group Enabled
*/}}
{{- define "weaviate-alerts.alertGroupEnabled" -}}
{{- $ranks := dict "critical" 1 "warning" 2 "info" 3 -}}
{{- $flags := (mustLast .) -}}
...
Alert Enabled
*/}}
{{- define "weaviate-alerts.alertEnabled" -}}
{{- $ranks := dict "critical" 1 "warning" 2 "info" 3 -}}
