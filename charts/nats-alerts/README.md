...
$ helm repo update
$ helm search repo appscode/nats-alerts --version=v2026.7.14
$ helm upgrade -i nats-alerts appscode/nats-alerts -n monitoring --create-namespace --version=v2026.7.14
```
...
| form.alert.groups.connectivity.rules.natsStalledClients.duration                        |                                               | <code>"15m"</code>                               |
...
```bash
$ helm upgrade -i nats-alerts appscode/nats-alerts -n monitoring --create-namespace --version=v2026.7.14 --set metadata.resource.group=apps
```
...
```bash
$ helm upgrade -i nats-alerts appscode/nats-alerts -n monitoring --create-namespace --version=v2026.7.14 --values values.yaml
```
